...
def sample_step_function_data():
    ...
    return {
        'execution_arn': 'arn:aws:states:us-east-1:123456789012:execution:aurastream-processor:test-execution-123',
        'state_machine_arn': 'arn:aws:states:us-east-1:123456789012:stateMachine:aurastream-processor',
        'input': {
            'job_id': 'test-job-123',
