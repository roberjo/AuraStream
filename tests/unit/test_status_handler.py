...
class TestStatusHandler:
    ...
    def test_get_job_status_function(self):
        ...
        with patch('src.handlers.status_handler.aws_clients') as mock_aws_clients:
            ...
            mock_aws_clients.get_dynamodb_resource.return_value.Table.return_value = mock_table
        ...
        # Test with error
        with patch('src.handlers.status_handler.aws_clients') as mock_aws_clients:
            mock_aws_clients.get_dynamodb_resource.side_effect = Exception("Database error")
