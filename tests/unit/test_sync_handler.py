...
class TestSyncHandler:
    ...
    def test_successful_sentiment_analysis(
        self, api_event, lambda_context, mock_comprehend_response
    ):
    ...
    @pytest.mark.parametrize(
        "sentiment,expected_score",
        [("POSITIVE", 0.95), ("NEGATIVE", 0.02), ("NEUTRAL", 0.02), ("MIXED", 0.01)],
    )
