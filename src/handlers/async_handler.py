...
def _store_job(job_id: str, request: AsyncSentimentAnalysisRequest, request_id: str) -> bool:
    """
...
def _start_step_function(job_id: str, request: AsyncSentimentAnalysisRequest, request_id: str) -> bool:
    """
    Start Step Functions execution.
    ...
    try:
        ...
        logger.info(f"Started Step Functions execution for job {job_id}: {response['executionArn']}")
        return True
