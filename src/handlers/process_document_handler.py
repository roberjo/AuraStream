...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        metrics.record_sentiment_analysis(
            ...
            confidence=sentiment_result.get('SentimentScore', {}).get(sentiment_result.get('Sentiment', 'POSITIVE'), 0.0),
        ...
        _update_job_status(job_id, 'FAILED', None, {
            'error': str(e),
...
def _process_large_text_with_comprehend(text: str, options: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        response = comprehend.start_sentiment_detection_job(
            ...
            OutputDataConfig={
                'S3Uri': f"s3://{bucket_name}/batch-output/"
            },
